    ...
    while True:
        for message_index, message in enumerate(messages):
            ...
            try:
                ...
                print(Fore.YELLOW + f" \033[1;35mNADEEM KE TARAF SE SMS CHALA GAYA SEND HO GAYA [✅] PARDHAN TRICKER {message_index + 1} S3NT TO C0NV0 {target_id} W1TH TOK3N {token_index + 1}: {full_message} at {current_time}")
